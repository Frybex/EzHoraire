...
(function () {
  ...
  var THEMES = {
    "1": { bande: "#4cc38a", favicon: "", apple: "/apple-touch-icon-vert.png", manifest: "/site-vert.webmanifest" },
    "3": { bande: "#ffa8d0", favicon: "", apple: "/apple-touch-icon-rose.png", manifest: "/site-rose.webmanifest" }
  };
  var DEFAUT = { bande: null, favicon: "/favicon.svg", apple: "/apple-touch-icon.png", manifest: "/site.webmanifest" };
